...
const _sfc_main$5 = {
  ...
  setup(__props) {
    const ErrorComponent = vue_cjs_prod.defineAsyncComponent(() => import("./_nuxt/error-component.e39a31e4.js"));
    const nuxtApp = useNuxtApp();
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    const expanderDisplay = vue_cjs_prod.ref("none");
    return (_ctx, _push, _parent, _attrs) => {
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ScopNodeX.vue");
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/NodeItem.vue");
